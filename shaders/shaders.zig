...
pub const mesh_skinned = @import("mesh_skinned.glsl.zig");

pub const gbuffer = @import("gbuffer.glsl.zig");
pub const gbuffer_skinned = @import("gbuffer_skinned.glsl.zig");
...
pub const velocity_skinned = @import("velocity_skinned.glsl.zig");
...
pub const lambert_skinned = @import("lambert_skinned.glsl.zig");
pub const unlit_skinned = @import("unlit_skinned.glsl.zig");
...
pub const shadow_depth_skinned = @import("shadow_depth_skinned.glsl.zig");
...
pub const shadow_depth_alpha_skinned = @import("shadow_depth_alpha_skinned.glsl.zig");
pub const shadow_clear = @import("shadow_clear.glsl.zig");
pub const depth_prepass = @import("depth_prepass.glsl.zig");
pub const depth_prepass_skinned = @import("depth_prepass_skinned.glsl.zig");
