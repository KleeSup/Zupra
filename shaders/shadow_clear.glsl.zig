...
//    Overview:
//    =========
//    Shader program: 'shadow_clear':
//        Get shader desc: shd.shadowClearShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_shadow_clear_pos => 0
//            ATTR_shadow_clear_uv => 1
//    Bindings:
//
pub const ATTR_shadow_clear_pos = 0;
pub const ATTR_shadow_clear_uv = 1;
//
//    #version 410
//
...
//
//
const vs_source_glsl410 = [148]u8 {
    ...
    0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x70,0x6f,0x73,0x2e,0x78,0x2c,0x20,0x70,0x6f,
    0x73,0x2e,0x79,0x2c,0x20,0x31,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x29,0x3b,0x0a,
    0x7d,0x0a,0x0a,0x00,
};
//
//    #version 410
...
//
//
const vs_source_glsl300es = [151]u8 {
    ...
    0x6f,0x6e,0x20,0x3d,0x20,0x76,0x65,0x63,0x34,0x28,0x70,0x6f,0x73,0x2e,0x78,0x2c,
    0x20,0x70,0x6f,0x73,0x2e,0x79,0x2c,0x20,0x31,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,
    0x29,0x3b,0x0a,0x7d,0x0a,0x0a,0x00,
};
//
//    #version 300 es
...
//    void vert_main()
//    {
//        gl_Position = float4(pos.x, pos.y, 1.0f, 1.0f);
//    }
//
...
const vs_source_hlsl5 = [530]u8 {
    ...
    0x20,0x20,0x20,0x20,0x67,0x6c,0x5f,0x50,0x6f,0x73,0x69,0x74,0x69,0x6f,0x6e,0x20,
    0x3d,0x20,0x66,0x6c,0x6f,0x61,0x74,0x34,0x28,0x70,0x6f,0x73,0x2e,0x78,0x2c,0x20,
    0x70,0x6f,0x73,0x2e,0x79,0x2c,0x20,0x31,0x2e,0x30,0x66,0x2c,0x20,0x31,0x2e,0x30,
    ...
    0x6e,0x70,0x75,0x74,0x2e,0x75,0x76,0x3b,0x0a,0x20,0x20,0x20,0x20,0x70,0x6f,0x73,
...
//    {
//        main0_out out = {};
//        out.gl_Position = float4(in.pos.x, in.pos.y, 1.0, 1.0);
//        return out;
//    }
//
//
const vs_source_metal_macos = [342]u8 {
    ...
    0x74,0x34,0x28,0x69,0x6e,0x2e,0x70,0x6f,0x73,0x2e,0x78,0x2c,0x20,0x69,0x6e,0x2e,
    0x70,0x6f,0x73,0x2e,0x79,0x2c,0x20,0x31,0x2e,0x30,0x2c,0x20,0x31,0x2e,0x30,0x29,
...
pub fn shadowClearShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "shadow_clear_shader";
    switch (backend) {
        .GLCORE => {
