...
//    Overview:
//    =========
//    Shader program: 'chromatic':
//        Get shader desc: shd.chromaticShaderDesc(sg.queryBackend());
//        Vertex Shader: vs
//        Fragment Shader: fs
//        Attributes:
//            ATTR_chromatic_pos => 0
//            ATTR_chromatic_uv => 1
//    Bindings:
...
//
pub const ATTR_chromatic_pos = 0;
pub const ATTR_chromatic_uv = 1;
...
//    void main()
//    {
//        vec2 _34 = v_uv - vec2(0.5);
//        vec2 _47 = (_34 * pow(length(_34) * 2.0, max(fs_params[0].y, 1.0))) * fs_params[0].x;
//        frag_color = vec4(textureLod(u_input_u_smp, v_uv - _47, 0.0).x, textureLod(u_input_u_smp, v_uv, 0.0).y, textureLod(u_input_u_smp, v_uv + _47, 0.0).z, 1.0);
//    }
//
//
const fs_source_glsl410 = [454]u8 {
    ...
    0x5f,0x33,0x34,0x20,0x3d,0x20,0x76,0x5f,0x75,0x76,0x20,0x2d,0x20,0x76,0x65,0x63,
    0x32,0x28,0x30,0x2e,0x35,0x29,0x3b,0x0a,0x20,0x20,0x20,0x20,0x76,0x65,0x63,0x32,
    0x20,0x5f,0x34,0x37,0x20,0x3d,0x20,0x28,0x5f,0x33,0x34,0x20,0x2a,0x20,0x70,0x6f,
    0x77,0x28,0x6c,0x65,0x6e,0x67,0x74,0x68,0x28,0x5f,0x33,0x34,0x29,0x20,0x2a,0x20,
    0x32,0x2e,0x30,0x2c,0x20,0x6d,0x61,0x78,0x28,0x66,0x73,0x5f,0x70,0x61,0x72,0x61,
    0x6d,0x73,0x5b,0x30,0x5d,0x2e,0x79,0x2c,0x20,0x31,0x2e,0x30,0x29,0x29,0x29,0x20,
    ...
    ,
...
//    void main()
//    {
//        highp vec2 _34 = v_uv - vec2(0.5);
//        highp vec2 _47 = (_34 * pow(length(_34) * 2.0, max(fs_params[0].y, 1.0))) * fs_params[0].x;
//        frag_color = vec4(textureLod(u_input_u_smp, v_uv - _47, 0.0).x, textureLod(u_input_u_smp, v_uv, 0.0).y, textureLod(u_input_u_smp, v_uv + _47, 0.0).z, 1.0);
//    }
//
//
const fs_source_glsl300es = [518]u8 {
    0x23,0x76,0x65,0x72,0x73,0x69,0x6f,0x6e,0x20,0x33,0x30,0x30,0x20,0x65,0x73,0x0a,
    ...
    0x69,0x67,0x68,0x70,0x20,0x76,0x65,0x63,0x32,0x20,0x5f,0x33,0x34,0x20,0x3d,0x20,
    0x76,0x5f,0x75,0x76,0x20,0x2d,0x20,0x76,0x65,0x63,0x32,0x28,0x30,0x2e,0x35,0x29,
...
//    void frag_main()
//    {
//        float2 _34 = v_uv - 0.5f.xx;
//        float2 _47 = (_34 * pow(length(_34) * 2.0f, max(_12_params.y, 1.0f))) * _12_params.x;
//        frag_color = float4(u_input.SampleLevel(u_smp, v_uv - _47, 0.0f).x, u_input.SampleLevel(u_smp, v_uv, 0.0f).y, u_input.SampleLevel(u_smp, v_uv + _47, 0.0f).z, 1.0f);
//    }
//
//    SPIRV_Cross_Output main(SPIRV_Cross_Input stage_input)
//    {
...
const fs_source_hlsl5 = [856]u8 {
    ...
    0x20,0x75,0x5f,0x69,0x6e,0x70,0x75,0x74,0x20,0x3a,0x20,0x72,0x65,0x67,0x69,0x73,
    0x74,0x65,0x72,0x28,0x74,0x30,0x29,0x3b,0x0a,0x53,0x61,0x6d,0x70,0x6c,0x65,0x72,
    0x53,0x74,0x61,0x74,0x65,0x20,0x75,0x5f,0x73,0x6d,0x70,0x20,0x3a,0x20,0x72,0x65,
    ...
    0x20,0x20,0x20,0x66,0x6c,0x6f,0x61,0x74,0x32,0x20,0x5f,0x33,0x34,0x20,0x3d,0x20,
    ...
    ,
...
//    };
//
//    fragment main0_out main0(main0_in in [[stage_in]], constant fs_params& _12 [[buffer(0)]], texture2d<float> u_input [[texture(0)]], sampler u_smp [[sampler(0)]])
//    {
//        main0_out out = {};
//        float2 _34 = in.v_uv - float2(0.5);
//        float2 _47 = (_34 * powr(length(_34) * 2.0, fast::max(_12.params.y, 1.0))) * _12.params.x;
//        out.frag_color = float4(u_input.sample(u_smp, (in.v_uv - _47), level(0.0)).x, u_input.sample(u_smp, in.v_uv, level(0.0)).y, u_input.sample(u_smp, (in.v_uv + _47), level(0.0)).z, 1.0);
//        return out;
//    }
//
//
const fs_source_metal_macos = [758]u8 {
    0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,0x20,0x3c,0x6d,0x65,0x74,0x61,0x6c,0x5f,
    0x73,0x74,0x64,0x6c,0x69,0x62,0x3e,0x0a,0x23,0x69,0x6e,0x63,0x6c,0x75,0x64,0x65,
    0x20,0x3c,0x73,0x69,0x6d,0x64,0x2f,0x73,0x69,0x6d,0x64,0x2e,0x68,0x3e,0x0a,0x0a,
    0x75,0x73,0x69,0x6e,0x67,0x20,0x6e,0x61,0x6d,0x65,0x73,0x70,0x61,0x63,0x65,0x20,
    ...
    0x5f,0x69,0x6e,0x70,0x75,0x74,0x20,0x5b,0x5b,0x74,0x65,0x78,0x74,0x75,0x72,0x65,
    ...
    ,
};
pub fn chromaticShaderDesc(backend: sg.Backend) sg.ShaderDesc {
    var desc: sg.ShaderDesc = .{};
    desc.label = "chromatic_shader";
    switch (backend) {
        .GLCORE => {
